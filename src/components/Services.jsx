  ...
  const services = [
    {
      ...
      description: "Craft lightning-fast, scalable websites that convert visitors into customers.",
      detailedDescription: "Full-stack development with cutting-edge frameworks including React, Next.js, Vue, and serverless architectures.",
      icon: <Code className="w-8 h-8" />,
      image: "https://images.pexels.com/photos/11035380/pexels-photo-11035380.jpeg?auto=compress&cs=tinysrgb&w=1000",
      features: ["PWA Development", "Headless CMS", "E-commerce", "Real-time Apps", "API Integration"],
    ...
    },
    {
      ...
      description: "Native and cross-platform apps that deliver exceptional performance.",
      detailedDescription: "Flutter, React Native, and native development with advanced features like AR/VR integration.",
      icon: <Smartphone className="w-8 h-8" />,
      image: "https://images.pexels.com/photos/147413/twitter-facebook-together-exchange-147413.jpeg?auto=compress&cs=tinysrgb&w=1000",
      features: ["Cross-Platform", "AR/VR Integration", "Push Notifications", "Offline Mode", "App Store Optimization"],
      gradient: "from-purple-600 via-purple-400 to-pink-400",
      accentColor: "purple",
      stats: { projects: "300+", satisfaction: "98%", downloads: "2M+" },
    },
    {
      id: 3,
      title: "UI/UX Design",
      ...
      detailedDescription: "Complete design systems from user research to pixel-perfect prototypes using Figma and Adobe Creative Suite.",
      icon: <Palette className="w-8 h-8" />,
      image: "https://images.pexels.com/photos/196644/pexels-photo-196644.jpeg?auto=compress&cs=tinysrgb&w=1000",
      features: ["Design Systems", "User Research", "Prototyping", "A/B Testing", "Accessibility"],
      gradient: "from-amber-600 via-orange-400 to-red-400",
      accentColor: "amber",
      stats: { projects: "400+", satisfaction: "97%", conversion: "+45%" },
    },
    {
      id: 4,
      ...
      detailedDescription: "AWS, Azure, and GCP deployment with DevOps automation, microservices, and serverless computing.",
      icon: <Cloud className="w-8 h-8" />,
      image: "https://images.pexels.com/photos/518543/pexels-photo-518543.jpeg?auto=compress&cs=tinysrgb&w=1000",
      features: ["Multi-Cloud", "Kubernetes", "CI/CD Pipelines", "Monitoring", "Auto-scaling"],
      gradient: "from-emerald-600 via-teal-400 to-cyan-400",
      accentColor: "emerald",
      stats: { projects: "200+", uptime: "99.9%", savings: "40%" },
    },
    {
      id: 5,
      ...
      detailedDescription: "Custom ML models, computer vision, NLP, chatbots, and predictive analytics using TensorFlow and PyTorch.",
      icon: <Bot className="w-8 h-8" />,
      image: "https://images.pexels.com/photos/8386434/pexels-photo-8386434.jpeg?auto=compress&cs=tinysrgb&w=1000",
      features: ["Computer Vision", "NLP Processing", "Predictive Analytics", "Chatbots", "Neural Networks"],
      gradient: "from-violet-600 via-purple-400 to-fuchsia-400",
      accentColor: "violet",
      stats: { models: "100+", accuracy: "95%", efficiency: "+60%" },
    },
    {
      id: 6,
      title: "Cybersecurity",
      ...
      detailedDescription: "Penetration testing, security audits, compliance, and advanced threat detection systems.",
      icon: <Shield className="w-8 h-8" />,
      image: "https://images.pexels.com/photos/60504/security-protection-anti-virus-software-60504.jpeg?auto=compress&cs=tinysrgb&w=1000",
      features: ["Penetration Testing", "Security Audits", "Compliance", "Threat Detection", "Incident Response"],
      gradient: "from-red-600 via-rose-400 to-pink-400",
      accentColor: "red",
      stats: { audits: "150+", threats: "99.8%", compliance: "100%" },
    }
  ];

  const testimonials = [
    { name: "Sarah Chen", company: "Tech Startup", rating: 5, text: "Revolutionary work that transformed our business." },
    { name: "Marcus Rodriguez", company: "E-commerce Giant", rating: 5, text: "Exceeded every expectation. Phenomenal results." },
    { name: "Emma Thompson", company: "Fortune 500", rating: 5, text: "The most professional team we've ever worked with." },
  ];
