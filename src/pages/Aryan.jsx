      ...
      >
        ...
        >
          ...
          >
            ...
            <div>
              <p
                className="text-gray-200 text-xl leading-relaxed text-center md:text-left"
                style={{ background: "transparent" }}
              >
                I am a passionate technologist with a deep love for philosophy,
                spirituality, and psychology. I believe that the intersection of
                these fields holds the key to creating innovative solutions that
                can truly transform our world.
                <br />
                <br />
                My journey in AI has been driven by relentless curiosity and a
                desire to leverage advancements for the greater good. I am
                particularly fascinated by how AI can be used to enhance
                emotional understanding and human connections. My interests
                extend to data science, machine learning (ML), large language
                models (LLMs), and research, fields that captivate me with their
                endless possibilities for innovation and solving complex
                problems.
                <br />
                <br />
                In addition to my passion for technology, I have a keen interest
                in filmmaking, content creation, and acting. I see storytelling
                as a powerful tool to inspire, educate, and bring about change.
                I also use AI to create beautiful visuals in films, as I believe
                content is the way to touch people’s hearts and spark
                inspiration.
                <br />
                <br />
                Understanding the human mind and behavior not only fascinates me
                but also informs my approach to technology and storytelling.
                Whether it’s through developing cutting-edge technology, or
                crafting engaging content, my goal is to contribute to a better,
        ...
        >
          ...
          <ol
            className="relative border-l-2 border-[#DE9F3A] ml-4"
            style={{ background: "transparent" }}
          >
            {experiences.map((exp, idx) => (
              ...
              >
                <span
                  className="absolute -left-5 top-3 w-4 h-4 bg-[#DE9F3A] rounded-full border-2 border-black"
                  style={{ background: "#DE9F3A" }}
                ></span>
                <h3
                ...
                <span
                  className="text-[#DE9F3A] text-lg font-medium"
                  style={{ background: "transparent" }}
                >
                  {exp.company}
                </span>
                ...
                <ul
                  className="list-disc text-gray-300 text-base max-w-2xl ml-5 space-y-1"
                  style={{ background: "transparent" }}
                >
                  {Array.isArray(exp.description) ? (
                    exp.description.map((point, i) => (
                      <li key={i} style={{ background: "transparent" }}>
                        {removeMdashes(point)}
                      </li>
                    ))
                  ) : (
                    <li style={{ background: "transparent" }}>
                      {removeMdashes(exp.description)}
                    </li>
                  )}
                </ul>
              </li>
        ...
        >
          ...
          <p
            className="text-gray-200 text-xl leading-relaxed text-center mb-3"
            style={{ background: "transparent" }}
          >
            My journey began with curiosity about how things work and how we
            connect. From tweaking front-end designs at midnight, to running
            video edits, to meditating on ways tech can heal, I found immense
            joy in learning and creating.
          </p>
          <p
            className="text-gray-300 text-lg leading-relaxed text-center"
            style={{ background: "transparent" }}
          >
            Today, I’m building at Endorphind, fusing technology, story, and
            wellness into meaningful digital adventures. The journey continues:
            always learning, always building, always connecting.
          </p>
        </section>
        <section
          className="w-full max-w-4xl mb-16"
                    ...
                    >
                      {project.url ? (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="hover:underline text-[#DE9F3A]"
                          style={{ background: "transparent" }}
                        >
                          {project.name}
                        </a>
        ...
        >
          ...
          <p
            ...
            style={{ background: "transparent" }}
          >
            My spiritual journey has been a continuous exploration of
            consciousness, purpose, and interconnectedness. From a young age, I
            found myself drawn to the deeper questions of existence, seeking
            meaning beyond the surface and aspiring to understand the intricate
            relationship between mind, spirit, and the universe.
          </p>
          <p
            className="text-gray-300 text-lg leading-relaxed text-center mb-3"
            style={{ background: "transparent" }}
          >
            Practices like meditation, yoga, and mindfulness have been
            instrumental in nurturing my inner awareness and resilience. These
            disciplines have not only provided clarity and grounding, but have
            deeply influenced how I navigate challenges, create, and relate to
            others. Through spiritual inquiry, I have learned to appreciate the
            beauty of presence, the power of silence, and the wisdom that comes
            from simply being.
          </p>
          <p
            className="text-gray-300 text-lg leading-relaxed text-center mb-3"
            style={{ background: "transparent" }}
          >
            Alongside these, I also regularly dabble into the realms of
            astrology and occult sciences, always with a spirit of curiosity and
            the intention of using these ancient knowledges for the well-being
            and benefit of all. Exploring astrology and occult teachings
            complements my spiritual pursuits, providing fresh perspectives and
            insights that support my own growth and help others find meaning,
            guidance, and harmony in their lives.
          </p>
          <p
            className="text-gray-300 text-lg leading-relaxed text-center"
            style={{ background: "transparent" }}
          >
            My work is an extension of this inner journey, an earnest attempt to
            channel creativity, compassion, and consciousness into everything I
            build and share. My vision is to bridge technology and spirituality,
            helping others find joy, connection, and purpose in the digital age
            while nurturing my own path towards a more awakened and harmonious
            existence.
          </p>
        </section>
      </main>
